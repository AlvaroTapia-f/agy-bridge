...
- THEN it MUST show the synchronized `agy-bridge/auto-ro-*` and `agy-bridge/auto-rw-*` models (reflecting 7 bases/14 ids if offline, verified live 2026-09-07), with `curl /v1/models` returning `200`
